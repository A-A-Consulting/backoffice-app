...
export const userRecordController = async (user: any) => {
  //console.log("🚀 ~ file: external-services.ts:16 ~ userRecordController ~ user", user)
  try {
    const response = await axios.post('/users/create', user)
    return response
  } catch (error) {
    console.log("🚀 ~ file: external-services.ts:10 ~ userRecordController ~ error", error)
    return null
  }
}
...
export const loging = async (data: any) => {
  try {
    ...
    //    console.log("🚀 ~ file: external-services.ts:8 ~ loging ~ response", response)
    return response
  } catch (error) {
...
export const getUsers = async () => {
  try {
    ...
    console.log("🚀 ~ file: external-services.ts:31 ~ getUsers ~ error", error)
    return null
  }
}
...
export const getUserById = async (id: string) => {
  try {
    ...
    console.log("🚀 ~ file: external-services.ts:41 ~ getUserById ~ error", error)
    return null
  }
}
...
export const updateUserById = async (user: any) => {
  try {
    ...
    console.log("🚀 ~ file: external-services.ts:52 ~ updateUserById ~ error", error)
    return null
  }
}
...
export const changeStateByAccountName = async (account_name: string, status: string) => {
  try {
    ...
    console.log("🚀 ~ file: external-services.ts:63 ~ changeStateByAccountName ~ error", error)
    return null
  }
}
...
export const changeRoleByAccountName = async (account_name: string, access: string) => {
  try {
    ...
    console.log("🚀 ~ file: external-services.ts:74 ~ changeRoleByAccountName ~ error", error)
    return null
  }
}
